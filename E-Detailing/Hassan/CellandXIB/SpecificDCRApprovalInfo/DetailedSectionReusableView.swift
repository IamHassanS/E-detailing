//
//  DetailedSectionReusableView.swift
//  SAN ZEN
//
...
class DetailedSectionReusableView: UICollectionReusableView {
    ...
    override func layoutSubviews()  {
        let labels: [UILabel] = [productLbl, promoterLbl, samplesLbl, rxQTYlbl]
