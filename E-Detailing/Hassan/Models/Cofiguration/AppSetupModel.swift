...
class AppSetUp : Codable {
  ...
  //  var sfTpDate : Double?
    ...
    var sfDCRDate : Dt?
    var pobCaption: String?
    var chemPOBCaption: String?
    var stockistPOBCaption: String?
    var unlistedPOBCaption: String?
    
    
    enum CodingKeys: String, CodingKey {
        case pobCaption = "Doc_pob_caption"
        case chemPOBCaption = "Chm_pob_caption"
        case stockistPOBCaption = "Stk_pob_caption"
        case unlistedPOBCaption = "Uldoc_pob_caption"
    ...
    required init(from decoder: Decoder) throws {
        ...
        self.pobCaption = container.safeDecodeValue(forKey: .pobCaption)
        self.chemPOBCaption = container.safeDecodeValue(forKey: .chemPOBCaption)
        self.stockistPOBCaption = container.safeDecodeValue(forKey: .stockistPOBCaption)
        self.unlistedPOBCaption = container.safeDecodeValue(forKey: .unlistedPOBCaption)
      ...
      //  self.success = container.safeDecodeValue(forKey: .success)
        ...
        LocalStorage.shared.setSting(.pobCaption, text: self.pobCaption ?? "POB")
        LocalStorage.shared.setSting(.chemPOBCaption, text: self.chemPOBCaption ?? "POB")
        LocalStorage.shared.setSting(.stockistPOBCaption, text: self.stockistPOBCaption ?? "POB")
        LocalStorage.shared.setSting(.unlistedPOBCaption, text: self.chemPOBCaption ?? "POB")
